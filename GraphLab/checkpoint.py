...
def load_ckpt(
    ...
    #epoch = cfg.train.epoch_resume
    path = os.path.join(cfg.train.resume_path, 'ckpt', str(epoch) + '.ckpt')

    print("Loading checkpoin from: ", path)
    ...
    for param_tensor in model.state_dict():
        print("Model param:", param_tensor)
        print("Original model param:", model.state_dict()[param_tensor])
