...
def set_cfg(cfg):
    r'''
    This function sets the default configs value.
    1) Note that for an experiment, only part of the arguments will be used
    The remaining unused arguments won't affect anything.
    So feel free to register any argument in graphgym.contrib.configs
    ...
    # cache dir
    cfg.dataset.dir = '/data0/yuanyz/NewGraph/datasets/'
    # cfg.dataset.dir = '../Run/datasets/'
    ...
    # exactly the same setting as the configs file
    ...
    cfg.transformer.feedforward_size = 512
    ...
    # L2 regularization
    cfg.optim.weight_decay = 0.00005
...
def assert_cfg(cfg):
    r"""Checks configs values, do necessary post processing to the configs"""
    ...
    if cfg.dataset.task_type == 'regression' and cfg.model.loss_fun == \
        ...
        logging.warning('model.loss_fun changed to cox for regression.')
...
def dump_cfg(cfg):
    r"""
    Dumps the configs to the output directory specified in
    :obj:`cfg.out_dir`
